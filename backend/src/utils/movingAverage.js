/**
 * Utility untuk menghitung Single Moving Average (SMA)
 * 
...
export function calculateSingleMovingAverage(historicalData = [], n = 3, currentStock = 0, minStock = 10) {
  ...
  // Mengambil n data historis terakhir
  ...
  // Rekomendasi pembelian: Kebutuhan periode depan + penyangga stok min - stok saat ini
